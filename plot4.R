...
plot(dataset$voltage ~ dataset$datetime, type="l", main = "",  xlab = "datetime", ylab = "Voltage")
...
plot(dataset$global_reactive_power ~ dataset$datetime, type="l", main = "", xlab = "", ylab = "Global Reactive Power (kilowatts)")
dev.off()
